...
public interface LoginHandler {
    ...
    public LoginResponse loginInit(int userId, Integer siteId, String uuid) throws ApiException, Exception;

    public LoginResponse login(int userId, LoginRequest request) throws ApiException, Exception;
}
