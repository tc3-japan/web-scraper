...
public enum ModelNoType {
	  ...
	  PRODUCT_2(1, Consts.AMAZON_PRODUCT_DETAIL_MODEL_NO_PRODUCT),
	  MAKER(2, Consts.AMAZON_PRODUCT_DETAIL_MODEL_NO_MAKER),
	  MODEL(3, Consts.AMAZON_PRODUCT_DETAIL_MODEL_NO_MODEL),;
