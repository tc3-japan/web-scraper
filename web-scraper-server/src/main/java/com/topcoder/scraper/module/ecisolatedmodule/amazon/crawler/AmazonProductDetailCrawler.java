...
public class AmazonProductDetailCrawler {
   ...
   * @throws IOException
   */
  public GeneralProductDetailCrawlerResult fetchProductInfo(TrafficWebClient webClient, String productCode, boolean saveHtml) throws IOException {
  ...
  * @throws IOException
  */
  public GeneralProductDetailCrawlerResult serarchProductAndFetchProductInfoByModelNo(TrafficWebClient webClient, String modelNo, boolean saveHtml) throws IOException  {
