...
@Component
public class GeneralChangeDetectionInitModule implements IChangeDetectionInitModule {

  private static final Logger LOGGER = LoggerFactory.getLogger(GeneralChangeDetectionInitModule.class);
