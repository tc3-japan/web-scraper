...
public class GeneralAuthenticationCrawler {

    private Logger logger = LoggerFactory.getLogger(GeneralAuthenticationCrawler.class.getName());
    ...
    public boolean authenticate(TrafficWebClient webClient, String username, String password) throws IOException {
        ...
        if (loginButtonInput == null)
            loginButtonInput = loginPage.querySelector(".login_box01 > p:nth-child(4) > button:nth-child(1)");
        System.out.println();
