...
import com.topcoder.scraper.module.PurchaseHistoryListCrawler;
import com.topcoder.scraper.module.PurchaseHistoryListCrawlerResult;
import com.topcoder.scraper.service.WebpageService;

public class YahooPurchaseHistoryListCrawler extends PurchaseHistoryListCrawler {
  ...
  public YahooPurchaseHistoryListCrawler(String siteName, WebpageService webpageService, String username,
      String password) {
    super(siteName, webpageService);
    this.siteName = siteName;
    this.webpageService = webpageService;
  ...
  public PurchaseHistoryListCrawlerResult fetchPurchaseHistoryList(TrafficWebClient webClient,
